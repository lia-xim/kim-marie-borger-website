	...
	fields: [
		...
		},
		{
			...
			fields: [
				...
				{ name: 'notes', label: 'Hinweise unter der Kontakt-CTA', type: 'string', list: true },
				{ name: 'defaultOccasion', label: 'Vorausgewaehlter Anlass im Formular', type: 'string' },
				{ name: 'sourceLabel', label: 'Seitenkontext fuer Anfrage-E-Mail', type: 'string' },
