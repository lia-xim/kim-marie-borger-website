...
| Production release | Full HTTP QA passed on `dpl_3RkDDwWimddeB9TBDXBcokzFmfRF`; commit-bound deployment `dpl_E5RcpzotAihJhuXHwQgh9MQiSjJr` is Ready and currently aliased to the apex and `www` domains | The committed 2026-07-29 SEO batch is public. |
